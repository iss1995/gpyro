...
def config():
        ...
        # (G_reg, F_reg, M_reg, output_scale, length_mean, length_var) = (5.e-3, 1.e-06, 5.e-3, 0.5, 0.1, 0.05) 
        (G_reg, F_reg, M_reg, output_scale, length_mean, length_var) = (0.06644715411010535, 3.3690058022490944e-05, 0.00014204223675027495, 0.2026995662865173, 0.004982128296440723, 0.0010098752448723196)
        epochs = 20
